...
Eigen::Matrix4f get_projection_matrix(float eye_fov, float aspect_ratio, float zNear, float zFar)
{
    ...
    float t = tan(eye_fov*M_PI/180/2) * abs(n);
    float r = t * aspect_ratio;
    float l = -r, b = -t;
    per << 2 * n / (r - l), 0, (l + r)/(l - r), 0,
            0, 2 * n / (t - b), (b + t) / (b - t), 0,
...
Eigen::Vector3f texture_fragment_shader(const fragment_shader_payload& payload)
{
    ...
    auto l1 = light{ {20, 20, -10}, {600, 600, 600} };
    auto l2 = light{ {-20, 20, -20}, {600, 600, 600} };
...
Eigen::Vector3f phong_fragment_shader(const fragment_shader_payload& payload)
{
    ...
    auto l1 = light{{50, 50, 50}, {500, 500, 500}};
...
int main(int argc, const char** argv)
{
    ...
    objl::Loader Loader;
    std::string obj_path = "/Users/manmanto/Documents/Xcode/GAMES02/GAMES02/models/spot/";

    // Load .obj File
    bool loadout = Loader.LoadFile("/Users/manmanto/Documents/Xcode/GAMES02/GAMES02/models/spot/spot_triangulated_good.obj");
