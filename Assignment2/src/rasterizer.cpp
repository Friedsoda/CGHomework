...
{
    Eigen::Vector3f point = Eigen::Vector3f(x, y, _v[0].z());
    Eigen::Vector3f p1 = _v[0] - point;
    Eigen::Vector3f p2 = _v[1] - point;
    Eigen::Vector3f p3 = _v[2] - point;
    Eigen::Vector3f t1 = p1.cross(p2);
    Eigen::Vector3f t2 = p2.cross(p3);
    Eigen::Vector3f t3 = p3.cross(p1);
    ...
    for(int x = x_min; x < x_max; x++){
        for(int y = y_min; y < y_max; y++){
            if(insideTriangle(x + 0.5, y + 0.5, t.v)){
                ...
                if(z_interpolated <= depth_buf[height*y+x]){
                    depth_buf[height*y+x] = z_interpolated;
